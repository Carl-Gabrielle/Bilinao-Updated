    ...
    return (
        <>
                ...
                <div className="container mx-auto px-4 py-8 pt-10">
                    ...
                    <span className='text-gray-700 hover:underline'>Seller Profile</span>
                    </div>
                    {/* Profile Section */}
                    <div className="bg-white shadow-lg rounded-3xl overflow-hidden">
                        ...
                        <div className="relative -mt-16 flex justify-center">
                            {/* Profile Image */}
                            <img
                                src={seller.profile_photo_url || '/images/default-profile.png'}
                                alt="Profile"
                        ...
                        <div className="text-center mt-4 py-4">
                            ...
                            <p className="text-gray-500">{seller.username || 'No username provided'}</p>
                            <p className="text-md text-slate-800">{seller.email}</p>
                            <div className="flex items-center justify-center mt-4 space-x-16">
                        <div className="text-center">
                            <span className="block text-xl font-medium">1</span>
                            <span className="text-sm text-gray-500">Products</span>
                        </div>
                        <div className="text-center">
                            <span className="block text-xl font-medium">0</span>
                    ...
                    <div className="mt-8 space-y-6">
                        <div className="bg-white shadow-md rounded-3xl p-6">
                            ...
                            <p className="text-gray-600 mt-2">
                                {seller.about || 'No information provided about this seller.'}
                            </p>
                        </div>
                        ...
                        <div className="bg-white shadow-md rounded-3xl p-6">
                            ...
                            <div className="space-y-2 mt-4">
                                ...
                                <p className="text-gray-600">
                                    <span className="font-semibold">Phone:</span> {seller.contact_number || 'Not provided'}
                                </p>
                                <p className="text-gray-600">
                                    <span className="font-semibold">Username:</span> @{seller.username || 'Not provided'}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white shadow-md rounded-3xl p-6">
                            <h3 className="text-xl font-semibold text-gray-800 border-b pb-2">Products by {seller.name}</h3>
