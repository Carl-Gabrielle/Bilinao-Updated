                                ...
                                <table className="min-w-full">
                                    ...
                                    <tbody>
                                        {arrivedOrders.data.length > 0 ? (
                                            arrivedOrders.data.map((order, index) => (
                                                <tr
                                                    key={order.id}
                                                ...
                                                >
                                                    <td className="py-4 px-6 text-slate-800">
                                                        <div className="truncate max-w-[150px]">
                                                            {arrivedOrders.current_page === 1
                                                                ? index + 1
                                                                : (arrivedOrders.current_page - 1) * arrivedOrders.per_page + index + 1}
                                                        </div>
                                                    </td>
                                                    <td className="py-4 px-6 text-slate-800">
                                                        {order.name}
                                                    ...
                                                    <td className="py-4 px-6 text-slate-800">
                                                        <span className="bg-purple-200 text-purple-800 text-medium font-semibold px-3 py-1 rounded-full">
                                                            Arriving
                                                        </span>
                                                    </td>
                                                    <td className="py-4 px-6 text-slate-800">
                                                        <Link
                                                            href={route("seller.OrderDetails", { id: order.id })}
                                                        >
