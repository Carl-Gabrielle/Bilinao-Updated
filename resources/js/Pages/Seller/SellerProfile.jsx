        ...
        <SellerLayout user={user}>
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="bg-white shadow-lg rounded-3xl overflow-hidden">
                    {/* Cover Image */}
                    <div className="bg-lime-700 h-32"> 
            ...
            <div className="mt-8 space-y-6">
                <div className="bg-white shadow-md rounded-xl p-6">
                        ...
                        <p className="text-gray-600 mt-2">
                            This is the seller's profile. Here you can find all details about the seller, their offerings, and more information.
                        </p>
                    </div>
                    <div className="bg-white shadow-md rounded-xl p-6">
                        ...
                        <div className="space-y-2 mt-4">
                            ...
                            <p className="text-gray-600">
                                <span className="font-semibold">Phone:</span> {user.contact_number || 'Not provided'}
                            </p>
                            <p className="text-gray-600">
                                <span className="font-semibold">Username:</span> {user.username || 'Not provided'}
                            </p>
                        </div>
                    </div>
            </div>
