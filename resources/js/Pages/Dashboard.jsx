...
export default function AdminDashboard({ auth }) {
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 z-0">
        <div className="bg-white p-6 rounded-3xl flex flex-col  items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform duration-300">
            ...
            <span className="font-bold text-3xl text-gray-800">125</span>
            <span className="font-medium text-sm text-gray-500 mt-2">Total Products</span>
        </div>
        <div className="bg-white p-6 rounded-3xl flex flex-col items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform duration-300">
            <div className="flex items-center justify-center bg-lime-100 rounded-full p-3 mb-4">
                <FaRegUser className="text-lime-700 text-2xl" />
            </div>
            <span className="font-bold text-3xl text-gray-800">56</span>
            <span className="font-medium text-sm text-gray-500 mt-2">Total Sellers</span>
        </div>
        <div className="bg-white p-6 rounded-3xl flex flex-col items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform duration-300">
            <div className="flex items-center justify-center bg-lime-100 rounded-full p-3 mb-4">
                <BsBasket2  className="text-lime-700 text-2xl" />
            </div>
            <span className="font-bold text-3xl text-gray-800">45</span>
            <span className="font-medium text-sm text-gray-500 mt-2">Total Orders</span>
        </div>
        <div className="bg-white p-6 rounded-3xl flex flex-col items-center justify-center shadow-lg hover:shadow-xl transform hover:scale-105 transition-transform duration-300">
            <div className="flex items-center justify-center bg-lime-100 rounded-full p-3 mb-4">
            ...
            <span className="font-medium text-sm text-gray-500 mt-2">Total Category</span>
        </div>
    </div>
</div>
            </div>
