        ...
        <GuestLayout>
            ...
            <div className="rounded-t-3xl sm:rounded-none scroll max-w-4xl lg:px-32 p-10 mx-auto w-full sm:h-full order-2 lg:order-1 bg-white overflow-y-auto">
                <div className="mt-5 w-full flex flex-col">
                    <Link
                        href="/sellerLogin"
                        className="inline-flex items-center text-sm px-6 py-2 w-80 mb-2 text-white bg-lime-700 rounded-lg shadow-md transition-colors duration-300 font-semibold"
                    >
                        <FaRegUser className="mr-2" />
                        Log In to Your Seller Account
                        <MdOutlineKeyboardArrowRight className='ml-2'/>
                    </Link>
                    <h1 className="text-2xl font-bold text-slate-800 mb-2">Welcome to Bili-Nao!👋</h1>
                    <p className="text-gray-600 mb-8">New to Bili-Nao? <Link href="/register" className="text-lime-700 font-semibold">Create an Account</Link></p>
                    <form onSubmit={submit} className="mt-2">
                        <div className="mb-6">
                            <InputLabel htmlFor="email" value="Email Address" className="block text-sm font-medium text-gray-600" />
                            <TextInput
                                id="email"
                                type="email"
                                name="email"
